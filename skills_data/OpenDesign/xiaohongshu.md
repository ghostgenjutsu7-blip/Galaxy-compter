---
name: Design System: xiaohongshu
source: OpenDesign
version: 1.0.0
description: Category: Media & Consumer
tags: ["design-system", "xiaohongshu"]
triggers: ["xiaohongshu"]
license: Apache-2.0
target_agent: design
 ...
 *   - --accent: #ff2442 (token red, default);
  --accent-hover: #ff2e4d

...
```css
:root {
  --bg: #171717` and `--surface: #1c1c1c` instead of pure black.
 *      DESIGN.md §1: "deep black backgrounds (`#0f0f0f`, `#171717`)" but
 *      "never pure black". The #1c1c1c surface gives cards a faint
 *      luminance step above the page without warm-shifting;
  --border: #2e2e2e` and `--border-soft: #242424` as solid hex,
